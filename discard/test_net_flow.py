...
CKPT_PATH = '/data2/hdu/shh/ckpt-station/flow-160.ckpt'
...
parser.add_argument('--save_scores', type=str, default="/data2/hdu/shh/flow-score/score_", help="./score/score_warmup_flow_2_")
...
if args.save_scores is not None:
    ...
    np.savez('/data2/hdu/shh/flow-score/flow_scores.npz', scores=reorder_output, labels=reorder_label)
    print('*'*50, '/data2/hdu/shh/flow-score/flow_scores.npz saved!', '*'*50)

    # print('+'*50, 'np.savetxt() testing ...', '+'*50)
    # print('Saving labels_output.txt...')
    # np.savetxt('/data2/hdu/shh/flow-score/labels_output.txt', reorder_label)
    # print('/data2/hdu/shh/flow-score/labels_output.txt saved!')
    #
    # print('+'*50, 'np.txt() testing ...', '+'*50)
    # print('Saving labels_output.txt...')
    # np.savetxt('/data2/hdu/shh/flow-score/scores_output.txt', reorder_output)
    # print('/data2/hdu/shh/flow-score/scores_output.txt saved!')

    # print('+'*50, 'np.save() testing ...', '+'*50)
    # print('Saving labels_output.npy...')
    # np.save('/data2/hdu/shh/flow-score/labels_output.npy', reorder_label)
    # print('/data2/hdu/shh/flow-score/labels_output.npy saved!')
    #
    # print('Saving scores_output.npy...')
    # np.save('/data2/hdu/shh/flow-score/scores_output.npy', reorder_output)
    # print('/data2/hdu/shh/flow-score/scores_output.npy saved!')
