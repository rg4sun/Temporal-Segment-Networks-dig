...
CKPT_PATH = '/data2/hdu/shh/ckpt-station/rgb-280.ckpt'
...
parser.add_argument('--weights', type=str, default=CKPT_PATH) # 测试rgb
...
if args.save_scores is not None:
    ...
    # 增加提示
    print('+' * 100)
    print('args.save_scores+args.modality = {}'.format(args.save_scores+args.modality))
    # print('-' * 100)
    ...
    print('*' * 50, '/data2/hdu/shh/rgb-score/rgb_scores.npz!', '*' * 50)
