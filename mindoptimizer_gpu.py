...
CKPT_PATH =  os.path.join(ROOT_PATH[PLATFORM], 'init-ckpt/tsn_flow.ckpt')
EPOCH = 100
GPU_ID = 1
...
parser.add_argument('--pretrained_path', type=str, default=CKPT_PATH) # 加载epoch52中最佳的ckpt
# parser.add_argument('--pretrained_path', type=str, default=None) # RGB 模式没有预训练文件
parser.add_argument('--device_id', default=GPU_ID, type=int) # flow放卡4跑
...
# ========================= Learning Configs ==========================
parser.add_argument('--epochs', default=EPOCH, type=int, help='number of total epochs to run') # epoch原本写的450
...
parser.add_argument('--eval_start_epoch', default=10, type=int, help='')
...
# parser.add_argument('--ckpt_save_dir', type=str, default="/home/flow_checkpoint")
parser.add_argument('--ckpt_save_dir', type=str, default=path_attacher("flow_checkpoint"))
